"""
Stock Analysis Korea Defence

Educational script demonstrating stock analysis korea defence concepts.
"""

# ============================================================================
# stock_analysis_NORMALIZED_ADJUST_CLOSE_DEFENCE_INDUSTRY_IN_KOREA.py
# ============================================================================
...
if __name__ == "__main__":
    tickers_str = ['Hanwha Aerospace', 'Hyundai Rotem', 'LIG Nex1', 'KAI']
