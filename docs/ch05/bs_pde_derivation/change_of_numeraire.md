...
By the [change-of-numéraire theorem](numeraire_and_change_of_measure.md#change-of-numéraire-theorem), the density process from $\mathbb{Q}$ to $\mathbb{Q}^S$ is
