...
- derivatives and collateral chains,
- common asset holdings.

These links create channels for shock transmission.
...
Small shocks may trigger large system-wide effects.
...
- edges represent exposures,
- topology affects resilience.

Dense networks can be robust or fragile depending on structure.
...
Stress tests often approximate these effects.
...
- Network structure matters for stability.
