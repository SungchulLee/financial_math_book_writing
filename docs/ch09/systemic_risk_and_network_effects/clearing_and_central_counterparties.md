...
- enforcing margining and default management,
- reducing bilateral counterparty risk.

They simplify exposure networks.
...
- require robust governance and capital.

CCP failure would have severe consequences.
...
- can amplify liquidity demand,
- may contribute to fire sales.

Balancing resilience and procyclicality is challenging.
...
- coordinating cross-border regulation.

CCPs are central to post-crisis reforms.
