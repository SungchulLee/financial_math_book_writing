...
- conservative limits and buffers.

Diversity reduces reliance on any single model.
...
Human judgment complements quantitative tools.
...
- stress results override point estimates,
- simplicity is often preferred.

Robustness favors transparency over complexity.
...
- Governance and culture are critical.
