...
## Economic Interpretation: Time Value and Risk

**Beyond the mathematics, understanding the economics:**

### Duration as Weighted Average Maturity
...
### Duration as Interest Rate Elasticity
...
### Term Structure and Economic Expectations
...
### Delta (Duration): First-Order Risk
...
### Theta (Carry/Roll-down): Time Decay
...
### Vega (Volatility Risk): Not Directly Applicable
...
### Rho (Level Risk): Same as Duration
...
## Strategy Selection: Duration Positioning

**Different duration strategies for different views:**

### Long Duration (Bullish on Bonds)
...
### Short Duration (Bearish on Bonds)
...
### Barbell Strategy (High Convexity)
...
### Ladder Strategy (Cash Flow Matching)
...
## Time Selection: When to Adjust Duration
...
### Long Duration Trade (2008 Crisis)
...
### Duration-Neutral Barbell (Volatility Play)
...
### The Golden Rule: Duration-Based Sizing
...
### Mistake #2: Using Modified Duration for Callable Bonds
...
### Mistake #3: Assuming Parallel Shifts
...
### Mistake #4: Forgetting Pull-to-Par
...
### Mistake #5: Over-Leveraging Based on Low Duration
...
### Mistake #6: Ignoring Convexity Sign
...
### Mistake #7: Mixing Macaulay and Modified Duration
...
### Mistake #8: Calculating Duration Wrong Frequency
...
### Mistake #9: Static Duration Management
...
### Mistake #10: Ignoring Credit Duration Interaction
...
### The Perfect Duration Trade (2008 Crisis)
...
### The Duration Disaster (2022 Rate Hike Cycle)
