...
## Economic Interpretation: Why Carry and Roll Work

**Beyond the mechanics, understanding the economic rationale:**

### Term Premium and Upward-Sloping Curves
...
### Convexity and Roll-Down Enhancement
...
## Strategy Selection: Which Bonds for Carry/Roll

**Different bonds offer different carry/roll profiles:**

### Maximum Roll Strategy (10-Year Point)
...
### High Carry Strategy (Credit Bonds)
...
### Leveraged Carry/Roll (Hedge Fund Strategy)
...
## Time Selection: When to Employ Carry/Roll
...
### Maximum Profit (2010-2011 QE2 Era)
...
### Maximum Loss (2022 Fed Hiking Cycle)
...
### The Golden Rule: Size by Duration and Volatility
...
### Mistake #1: Ignoring Financing Costs
...
### Mistake #2: Using Carry/Roll in Hiking Cycles
...
### Mistake #4: Chasing Roll at Long End
...
### Mistake #7: Confusing Yield and Total Return
...
### Mistake #8: Market Timing the Curve
...
### Mistake #9: Forgetting Pull-to-Par
...
### The Perfect Carry/Roll Environment (2003-2006)

**Trader profile:**

- Experience: 25 years fixed income
- Capital: $500M hedge fund
- Strategy: Systematic carry/roll
...
**Multi-year carry/roll:**
- 60% in 10-year Treasuries
- 40% in IG corporates (BBB)
- 3× leverage (repo financing)
- Duration: 8 years weighted
- Notional: $1.5B on $500M equity

**Year 1 (2003):**

**10-year Treasuries:**
- Yield: 4.00%
- Carry: 4.00% - 1.10% = +2.90%
- Roll-down (curve 300 bps): +2.30%
- Yield change: -50 bps (fell to 3.50%)
- Gain from yield fall: 8 × 0.50% = +4.00%
- **Total: +9.20% on 60% × 3× = +16.6% contribution**

**IG Corporates:**
- Yield: 6.50%
- Carry: 6.50% - 1.10% = +5.40%
- Roll: +1.80%
- Spread tightening: -30 bps
- Gain: 7 × 0.30% = +2.10%
- **Total: +9.30% on 40% × 3× = +11.2% contribution**

**Year 1 total: 16.6% + 11.2% = 27.8%**

**Year 2-3 (2004-2006):**

**Fed hiking but predictably:**
- Fed went from 1% → 5.25% over 2 years
- But telegraphed (25 bps per meeting)
- Curve flattened but stayed steep (150+ bps)
- Yields rose but slowly

**Repositioning:**
- Reduced leverage 3× → 2×
- Shortened duration 8 → 6 years
- Increased corporates 40% → 60%
- **Adaptive**

**2004 return:**
- Carry: +4.00%
- Roll: +1.50%
- Yield rise: -30 bps × 6 = -1.80%
- **Net: +3.70% unleveraged, +7.4% with 2× leverage**

**2005 return:**
- Similar: +6.8%

**2006 return:**
- Fed paused, curve re-steepened
- **+12.5%**

**3-year cumulative (2003-2006):**

$$
(1.278)(1.074)(1.068)(1.125) = 1.64
$$

**Total: +64% over 3.5 years**
...
1. ✅ Entered at ideal time (post-recession, steep curve)
2. ✅ Multi-year favorable environment (low vol)
3. ✅ Adaptive management (reduced leverage during hikes)
4. ✅ Diversified (Treasuries + corporates)
5. ✅ Disciplined risk management (capped at 3× leverage)
6. ✅ Long holding period (harvested full cycle)
7. ✅ Exited before 2007 crisis
8. **Institutional execution**

---

## Worst Case Scenario

### The Late-Cycle Disaster (2021-2022)

**Trader profile:**

- Experience: 4 years
- Capital: $25M family office
- Strategy: "Safe" carry/roll for income
- Discipline: Poor
...
- "Bonds always deliver steady returns"
- "Carry/roll is low risk"
- "Fed won't really hike much"
- **Complacency**

**Position (December 2021):**

**All-in long duration:**
- 100% 30-year Treasuries
- Notional: $75M (3× leverage)
- Duration: 18 years
- Entry yield: 1.90%
- Repo: 0.05%
...
- Maximum roll potential
- Curve steep (180 bps)
- Positive carry (1.90% - 0.05% = 1.85%)
- **Seemed perfect**

**Ignored warnings:**

- CPI at 6.8% (40-year high)
- Fed signaling hawkish shift
...
- Fed hikes 75 bps (Mar)
- 30-year yield: 1.90% → 2.40% (+50 bps)
- Duration 18 × 50 = -9% loss
- On $75M: -$6.75M
- Repo rising: 0.05% → 0.50%
- **Account: $25M → $18.25M (-27%)**
...
- Fed hikes 150 bps (50 + 50 + 50)
- 30-year: 2.40% → 3.30% (+90 bps)
- Loss: 18 × 0.90% = -16.2%
- On $75M: -$12.15M
- But account only $18.25M!
- **Margin call**

**Forced liquidation:**

- Broker liquidated at 3.30% yield
- Sold into worst market
- Realized losses
...
- Started: $25M
- Margin call forced sale: $6M remaining
- **-76% loss in 6 months**

**Emotional destruction:**

- Family wealth devastated
- Trust broken
- Career ended
- **Personal disaster**
...
1. ❌ Ignored inflation (6.8% CPI screaming warning)
2. ❌ Ignored Fed hawkish pivot
3. ❌ Maximum duration (30-year = worst choice)
4. ❌ Leveraged 3× (amplified disaster)
5. ❌ No stop-loss (rode to bottom)
6. ❌ Denial (didn't adapt to new environment)
7. ❌ "Safe bonds" fallacy
8. ❌ Overleveraged "low risk" strategy
9. **Complete failure of risk management**

**Lessons:**

- Carry/roll NOT "safe" in all environments
...
$$
\text{Total Return} = \text{Carry} + \text{Roll} + \text{Yield Change}
$$

- Carry = Coupon - Financing
- Roll = Mechanical price gain on upward curve
- Yield Change = Market risk
- **Three distinct components**

### Carry Calculation

$$
\text{Carry} = \frac{\text{Coupon}}{\text{Price}} - \text{Repo Rate}
$$
...
**On upward-sloping curve:**
- Bond ages → Lower yield point
- Yield falls → Price rises
- Automatic gain if curve unchanged
- **Mechanical return**

**Magnitude:**
- Depends on curve steepness
- 10-year typically optimal (1.5-2.0% annually)
- **Predictable if curve stable**

### Optimal Conditions

**Perfect environment:**
- Steep curve (>150 bps)
- Stable yields (vol <15 bps/month)
- Low financing (repo <coupon)
- Fed on hold
- **2003-2006, 2009-2013**
...
**Destroys carry/roll:**
- Fed hiking (yields rise)
- Inverted curve (negative roll)
- High volatility (noise >signal)
- Rising repo costs
- **2022 disaster**

### Leverage Guidelines

**Conservative: 0-1× (unleveraged)**
**Moderate: 2-3× (standard hedge fund)**
**Aggressive: 4-5× (maximum)**
**Dangerous: >5× (avoid)**

### Position Sizing

$$
\text{Size} = \frac{\text{Risk Budget}}{\text{Duration} \times \text{Yield Vol}}
$$
...
2. Using in hiking cycles
3. Overleveraging
4. Chasing long-end roll
5. Ignoring convexity
6. No exit plan
7. Confusing yield and total return
8. Market timing
9. Forgetting pull-to-par
10. Ignoring liquidity

### Historical Performance

**Best environment (2003-2006):**
- Annual return: 15-20% (leveraged)
- Sharpe ratio: >2.0
- Max drawdown: <5%
- **Golden era**

**Worst environment (2022):**
- Annual return: -30% to -40%
- Sharpe ratio: -2.0
- Max drawdown: 40%
- **Disaster**
...
1. **Environment** (stable, steep curve)
2. **Execution** (proper leverage, diversification)
3. **Discipline** (stop-losses, Fed monitoring)

**Formula:**

$$
\text{Success} = \text{Right Regime} \times \text{Proper Structure} \times \text{Risk Management}
$$
