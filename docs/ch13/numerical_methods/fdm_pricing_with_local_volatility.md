# FDM Pricing with Local Volatility

This section explores the principles and methods underlying fdm pricing with local volatility, which form a critical component of modern financial mathematics.
