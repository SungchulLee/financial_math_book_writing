...
![geometric_brownian_motion_via_euler_maruyama](./image/geometric_brownian_motion_via_euler_maruyama.png)
...
![OU_Terminal_Distribution_Comparison_Exact_vs_Euler_Maruyama](./image/OU_Terminal_Distribution_Comparison_Exact_vs_Euler_Maruyama.png)
...
1. **Accuracy requirement:** $\Delta t \lesssim \varepsilon^{2/\gamma}$ for target strong error $\varepsilon$
2. **Stability:** For mean-reverting SDEs, $a \Delta t < 1$
