...
- decision-makers distrust a single reference measure.

Max–min utility reflects a cautious, worst-case attitude.
...
- conservative portfolio choices,
- endogenous model pessimism.

It generalizes classical expected utility.
...
- robust asset pricing,
- conservative risk management.

The approach often reduces leverage and risk-taking.
...
- Robustness is prioritized over optimality.
