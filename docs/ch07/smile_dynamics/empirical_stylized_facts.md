...
- skew relaxes slowly over time,
- skew dynamics are asymmetric.

This is often referred to as the leverage effect in implied space.
...
- long-term smiles are more stable,
- volatility shocks propagate gradually across maturities.
...
- strong persistence,
- slow mean reversion,
- clustering similar to realized volatility.
...
- equity index smiles show strong downside skew,
- single stocks show idiosyncratic behavior.
...
- Stylized facts guide model development and validation.
