...
### Example: The 3-2-1 Crack Spread
...
### Example: The Soybean Crush Spread
...
## Economic Interpretation: Spreads as Arbitrage and Mean Reversion

**Beyond the basic mechanics, understanding the economic rationale:**

### Processing Spreads as Producer Margins
...
### Substitution Spreads and Relative Demand
...
### Correlation Risk (Unique to Spreads)
...
### Crush Spreads (Agriculture) - Second Most Popular
...
### Gold/Silver Ratio - Macro Indicator
...
### Corn/Wheat Spread - Feed Substitution
...
### The Golden Rule: Size by Spread Volatility
...
### Mistake #1: Trading Spreads Like Outrights
...
### Mistake #4: Trading Through Delivery
...
### Mistake #5: No Stop Loss on "Mean Reversion"
...
### Mistake #6: Overleveraging Due to Low Margin
...
### Mistake #8: Chasing Extreme Moves
...
### Mistake #9: Not Rolling Positions
...
### Mistake #10: Ignoring Correlation Changes
...
### The Perfect Crack Spread Trade

**Trader profile:**

- Experience: 7 years energy trading
- Account: $500,000
- Strategy: Fundamental crack spread trading
...
- Crude: $70/barrel (stable)
- Gasoline: $1.90/gal ($79.80/barrel)
- Diesel: $2.00/gal ($84.00/barrel)
- Crack spread: $11.60/barrel

**Analysis:**

$$
\text{Crack} = \frac{2 \times \$79.80 + 1 \times \$84.00}{3} - \$70 = \$11.53/\text{barrel}
$$

**z-score:**

$$
z = \frac{11.53 - 19}{6} = -1.24
$$
...
- Driving season approaching (May-Aug)
- Refinery maintenance finishing
- Product inventories 15% below 5-year average
- **Setup building**

**Entry (March 15):**

- Long 15 crack spreads @ $11.50/barrel
- Margin: $25,000 × 15 = $375,000
- Position: Long 30 RBOB + 15 HO, Short 45 CL
- Target: $21/barrel (mean)
- Stop: $9/barrel (fundamental break)

**Trade progression:**

**Week 1-2 (March 15-30):**

- Refineries complete maintenance
- Utilization: 85% → 88%
- Crack: $11.50 → $13.80
- **P&L: +$2.30 × 15,000 = +$34,500**

**Week 3-6 (April):**

- Driving season demand building
- Refineries increasing runs: 88% → 91%
- Product inventories declining
- Crude supply adequate
- Crack: $13.80 → $18.20
- **P&L: +$6.70 × 15,000 = +$100,500**

**Week 7-10 (May):**

- Memorial Day demand spike
- Gasoline demand at seasonal highs
- Crude at $72 (stable)
- Gasoline at $2.30/gal ($96.60/barrel)
- Diesel at $2.50/gal ($105/barrel)
- Crack: $18.20 → $23.50
- **P&L: +$12.00 × 15,000 = +$180,000**

**Exit decision (May 15):**
...
- Current: $23.50
- Gain: $12/barrel
- Target was $21, hit $23.50
- **Close 75% (11 spreads)**

**Profit:**

$$
\$12 \times 1,000 \times 11 = \$132,000
$$

**Let 4 spreads run with trailing stop**

**Week 11-12 (Late May):**

- Crack peaks at $26/barrel
- Trailing stop hit at $24.50
- Close remaining 4 spreads

**Final profit:**

$$
(\$24.50 - \$11.50) \times 1,000 \times 4 = \$52,000
$$

**Total:**

$$
\$132,000 + \$52,000 = \$184,000
$$

**Return:**

$$
\frac{\$184,000}{\$375,000} = 49\% \text{ in 60 days}
$$
...
1. ✅ Entered at narrow spread (below mean)
2. ✅ Fundamental catalyst (driving season)
3. ✅ Seasonal tailwind (summer)
4. ✅ Refinery utilization increasing
5. ✅ Product inventories low
6. ✅ Proper sizing (15 spreads reasonable)
7. ✅ Partial profit-taking at target
8. ✅ Trailing stop on remainder
9. **Textbook execution**

### The Perfect Crush Spread Short

**Different trader (2022):**

**Setup (November 2022 - post-harvest):**

**Market:**

- Soybeans: $12.80/bushel (harvest pressure)
- Meal: $390/ton (normal)
- Oil: 52¢/lb (normal)
...
$$
\text{Crush} = \frac{390 \times 2000}{60} + (52 \times 11) - 1280 = 13,000 + 572 - 1280 = 12,292 \text{ cents/bu}
$$

Wait, that's way too high. Let me recalculate:

$$
\text{Crush} = \frac{390 \times 2000}{60} + (52 \times 11) - 1280 \text{ cents}
$$

Converting meal: $390/ton = 39,000¢/ton

$$
= \frac{39,000}{60 \text{ lbs/bu}} \times 48 \text{ lbs meal} + 52¢ \times 11 \text{ lbs oil} - 1,280¢
$$
...
That's negative, which is wrong. Let me use the standard formula:

$$
\text{Crush (¢/bu)} = \frac{\text{Meal ($/ton)}}{11} + \text{Oil (¢/lb)} - \text{Beans ($/bu)}
$$

$$
= \frac{390}{11} + 52 - 12.80 = 35.45 + 52 - 12.80 = 74.65¢/\text{bu}
$$

**Let's use a simpler approach:**

Actually, the standard crush formula varies by source. Using the practical calculation:

- Crush at 95¢/bushel (wide, post-harvest)
- Historical mean: 70¢/bushel
- z-score: +1.7

**Entry:**

- Short 25 crush spreads @ 95¢/bushel
- Target: 68¢/bushel
- Stop: 105¢/bushel
...
$$
\text{P\&L} = 31¢ \times 5,000 \times 25 = \$38,750
$$

**On $75,000 margin = 52% return**

**These represent best-case executions with perfect timing, discipline, and fundamental analysis.**

---

## Worst Case Scenario

### The Crack Spread Catastrophe

**Setup (2005 Hurricane Katrina):**

**Trader:**

- Account: $300,000
- Position: Short 20 crack spreads @ $18/barrel
- Thesis: "Crack at historical high, will revert to $14"
- **No stop loss (confident in mean reversion)**

**August 29, 2005: Hurricane Katrina**

**Immediate impact:**

- Gulf Coast refineries shut down (30% of US capacity!)
- Gasoline supply disrupted
- Crude supply less affected (offshore platforms OK)
- **Crack spread explodes**

**Day 1 post-hurricane:**

- Crack: $18 → $35/barrel
- Loss: $17 × 1,000 × 20 = -$340,000
- **Account wiped out + owed $40,000**

**Why it failed:**

1. ❌ Shorted at "normal" not extreme
2. ❌ No stop loss (mean reversion assumption)
3. ❌ Overleveraged (20 spreads on $300k)
4. ❌ Ignored hurricane season risk
5. ❌ Fundamental shift (permanent capacity loss)
...
### The Crush Spread Chinese Demand Shock
...
- Account: $400,000
- Thesis: "Crush always mean-reverts, it's math"
- Position: Long 30 crush spreads @ 48¢/bushel
- Target: 75¢/bushel (mean)
- **No fundamental analysis**

**July 2018: African Swine Fever in China**

**Impact:**

- China's pig herd decimated (50% reduction)
- Soybean meal demand collapses (pigs eat meal)
- Soybean oil demand stable (human consumption)
- **Meal crashes, crush spread narrows**

**Progression:**

**Week 1-4:**

- Crush: 48¢ → 38¢ (narrowing)
- Loss: -10¢ × 5,000 × 30 = -$15,000
- Trader: "Just temporary"

**Week 5-12:**

- Crush: 38¢ → 25¢ (extreme narrow)
- Loss: -23¢ × 5,000 × 30 = -$34,500
- Margin calls begin

**Week 13-20:**

- Crush: 25¢ → 15¢ (unprecedented)
- Loss: -33¢ × 5,000 × 30 = -$49,500
- **Forced liquidation**
...
- Ending: $350,500
- Loss: -$49,500 (-12.4%)
- **But avoided total wipeout**

**What went wrong:**

1. ❌ Ignored fundamental analysis
2. ❌ "Mean reversion always works" fallacy
3. ❌ Didn't monitor Chinese hog herd
4. ❌ Oversized position (30 spreads)
5. ❌ No stop loss until margin call
6. ❌ Structural shift in meal demand
7. **Lesson: Mean reversion requires stable fundamentals**
...
**Inter-commodity spreads trade economic relationships:**

$$
\text{Spread} = \text{Output} - \text{Input} \quad \text{(processing)}
$$

$$
\text{Ratio} = \frac{\text{Commodity A}}{\text{Commodity B}} \quad \text{(substitution)}
$$

- Related commodities have predictable price relationships
- Relationships mean-revert around economic equilibrium
- Profit from relationship normalization
- Market-neutral to absolute prices
- Lower volatility than outrights
...
- Crack: Gasoline + Diesel - Crude ($15-25/barrel)
- Crush: Meal + Oil - Soybeans (60-80¢/bushel)
- Spark: Electricity - (Gas × Heat Rate)

**Substitution spreads:**

- Corn/Wheat: Ratio 0.90-1.10
- Gold/Silver: Ratio 50-80
- WTI/Brent: Brent premium $2-5/barrel

### Time Selection

**Enter when:**

- |z-score| > 2.0 (statistical extreme)
- Fundamental catalyst for reversion
- Seasonal tailwind present
- High correlation maintained (>0.70)

**Exit when:**

- Spread reaches mean ± 0.5σ
- Fundamental thesis breaks
- Time stop triggered (8-12 weeks)
...
- Win rate: 65-75%
- Average profit: 30-50% on margin
- Average loss: 15-25% (if managed)
- Holding period: 4-12 weeks

**Best case:**

- 3-2-1 Crack: 49% in 60 days (seasonal + fundamental)
- Soy Crush: 52% in 60 days (post-harvest mean reversion)
- Gold/Silver: 875% in 6 months (ratio 125 → 72)

**Worst case:**

- Crack spread: -113% (Hurricane Katrina, no stop)
- Crush spread: -12% (Chinese demand shock)
- **Structural changes can prevent reversion**

### When to Use

**Ideal situations:**

- Clear statistical extreme (|z| > 2)
- Fundamental catalyst for reversion
- Seasonal pattern supporting
- Institutional flows confirming
- Hedging production/consumption
...
- Correlation breakdown (<0.60)
- Both legs trending same direction
- Low liquidity markets
- During delivery weeks
...
- Statistical: Entry ± 1.5σ
- Fundamental: Exit if thesis breaks
- Time: Exit if no progress in 12 weeks

**Diversification:**

- Max 15-20% of portfolio in spreads
- Spread across types (crack, crush, ratios)
- Stagger entries over time
- Balance long and short spreads

### Common Mistakes

1. Trading spreads like outrights (ignoring relationship)
2. Ignoring fundamental drivers
3. Wrong contract ratios (not hedged)
4. Trading through delivery weeks
5. No stop loss ("mean reversion guaranteed")
6. Overleveraging due to low margin
7. Ignoring seasonality
8. Chasing extreme moves
9. Not rolling positions
10. Ignoring correlation changes

### Success Factors

**Three pillars:**

1. **Statistical analysis** (z-scores, mean reversion)
2. **Fundamental analysis** (why spread is extreme)
3. **Risk management** (stops, sizing, diversification)
