...
## Economic Interpretation: Why Swap Carry Works
...
### Forward Curve vs. Realized Rates
...
### Phase 2: Select Optimal Maturity
...
# Output: Maximum DV01: $5,000,000
```

**2. Calculate Notional:**

```python
# 5-year swap DV01: $4,500 per $1M
dv01_per_mm = 4500
...
# Output: Maximum notional: $1,111,111,111
...
```python
# Target DV01: $500,000 (1% of capital)
target_dv01 = 500_000

notional = (target_dv01 / dv01_per_mm) * 1_000_000
print(f"Target notional: ${notional:,.0f}")

# Output: Target notional: $111,111,111 (still large, round to $100M)
```
...
# Roll-down (approximate, assuming 10 bps aging benefit)
...
# Return on collateral (assume 2% initial margin)
...
# Example: Check after rates rise 50 bps
...
### Example 1: 5-Year Swap Carry - 2019 (Profitable)
...
### Example 2: 10-Year Swap Carry - 2022 (Disaster)
...
### Example 3: 2s5s Curve Carry - 2023 (Moderate Win)
...
### Better Example 3: Front-End Carry - 2017 (Consistent Grind)
...
### Example 4: 30-Year Carry + QE - 2020 (Lucky Timing)
...
### Example 5: Negative Carry Pay-Fixed - 2021 (Inflation Hedge)
...
### Best Case Example: 5-Year Carry 2009-2011 (Post-Crisis Recovery)
...
### Worst Case Example: 10-Year Swap 2022 (Inflation Shock)
