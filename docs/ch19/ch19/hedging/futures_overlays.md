...
### 1. The Separation of Alpha and Beta
...
### 3. Duration Contribution from Overlay
...
# Output:
# DV01-based contracts
# Beta-adjusted contracts
# Actual contracts to trade
```
...
### 1. Example 1: Pension Fund Duration Hedge
...
### 2. Example 2: Transition Management
...
### 4. Example 4: Duration Extension
...
### 5. Example 5: Failed Credit Hedge
...
### 2. Best Case Example: Insurance Company STRIP-Treasury Hedge
...
### 1. The Futures Overlay Disaster
...
### 2. Worst Case Example: Asset Manager Overleveraged Short
