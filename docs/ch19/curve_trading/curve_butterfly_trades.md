...
## Economic Interpretation: What Drives Butterfly Performance
...
### Fed Policy and Butterfly Behavior
...
### DV01-Weighted Butterfly Construction
...
### Phase 1: Identify Butterfly Opportunity
...
# Output: Current butterfly: -0.17 bps = -17.5 bps
```
...
# Example output:
# Historical mean: -0.0050 (-0.5 bps)
# Historical std: 0.0120 (1.2 bps)  
# Current fly: -0.0175 (-17.5 bps)
# Z-score: -1.04
```
...
### Phase 2: Construct DV01-Neutral Position
...
### Example 1: 2s5s10s During Fed Hiking - June 2022 (Profitable Trade)
...
### Example 2: 5s10s30s During QE - March 2020 (Loss)
...
### Example 3: Front-End Fly During Rate Cut - September 2024
...
### Example 4: 2s5s10s Carry Trade - Low Volatility Environment
...
### Example 5: 10s20s30s During Supply Surge - 2020
...
### Best Case Example: 2s5s10s Fed Pivot - December 2018
...
### Worst Case Example: QE Forever Butterfly - 2020-2021
