...
- **permanent impact:** lasting price changes due to information.

Both affect realized execution prices.
...
- execution speed,
- prevailing market volatility and liquidity.

Impact is nonlinear in trade size.
...
- square-root impact laws,
- optimal execution frameworks (Almgren–Chriss).

These models guide execution strategies.
...
- invalidates hedging assumptions,
- leads to overly aggressive trading strategies.

Market impact is critical in stress scenarios.
...
- Execution costs are integral to risk management.
