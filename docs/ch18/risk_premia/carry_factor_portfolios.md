...
### Why Carry Exists as a Risk Premium
...
## Economic Interpretation: Risk Premia and Structural Imbalances
...
### Uncovered Interest Parity (UIP) Failure
...
### Cross-Sectional vs. Time-Series Carry
...
### Carry Calculation by Asset Class
...
# Output: Crude Oil Carry: -22.81% (backwardation, positive carry for long)
```

### Phase 2: Portfolio Construction (Monthly Rebalancing)
...
# Output: Natural Gas: 6 contracts
```
...
### Phase 4: Quarterly Review and Adjustment
...
### Example 1: 2008 Financial Crisis - The Carry Crash
...
### Example 2: COVID Crash March 2020 - Lessons Learned
...
### Example 3: Natural Gas Backwardation Bonanza (Winter 2023-2024)
...
### Example 4: AUD/JPY Carry Trade - The Classic (2005-2007)
...
### Example 5: Institutional Carry Portfolio - AQR Style (2010-2024)
...
### Best Case Example: The Golden Years (2016-2018)
...
### Worst Case Example: The No-Vol-Targeting Disaster (2008 Redux)
