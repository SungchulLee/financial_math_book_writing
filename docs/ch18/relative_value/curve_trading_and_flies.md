...
### Core Concept - Butterfly Spreads
...
## Economic Interpretation: Term Structure Dynamics
...
### The Butterfly as a Curve Curvature Trade
...
### Curve Trading vs. Outright Position
...
### Phase 1: Market Selection and Curve Analysis
...
### Complete Example: Natural Gas Butterfly
...
### Delta (Price Sensitivity for Commodities)
...
### Example 1: Fed Pivot - 2s10s Steepener (Big Win)
...
### Example 2: Crude Oil Butterfly - Seasonality (Moderate Win)
...
### Example 3: Treasury Butterfly - QE Distortion (Loss)
...
### Example 4: Natural Gas Winter Spread (Big Win)
...
### Example 5: Eurodollar Fly - Rate Hike Expectations (Small Win)
...
### Position Sizing for Curve Trades
...
### The Perfect Curve Normalization

**Setup for maximum profitability:**

**Ideal conditions:**

1. **Extreme curve shape:** Far from historical norms (inverted or super-steep)
2. **Clear catalyst:** Fed policy, economic data, known event
3. **Patience rewarded:** Normalization takes 3-6 months
4. **Positive carry:** Collect roll yield while waiting
5. **Multiple sigma move:** 50+ bp curve change
6. **Low volatility:** Smooth normalization (no whipsaws)

### Best Case Example: Post-COVID Treasury Curve (2020-2021)

**Background:**

- COVID crash (March 2020)
- Fed cuts to zero, massive QE
- Curve extremely flat (0-50 bps 2s10s)
...
- 2-year yield: 0.15%
- 10-year yield: 0.65%
- **Spread: 50 bps (historically very flat)**
- Historical average: 100-150 bps

**Thesis:**

- Economy will recover (vaccine hopes)
- Fed will keep short rates at zero (ZIRP)
- Long rates will rise (growth + inflation)
- **Curve should steepen dramatically**

**Trade:**

- Short 50 ZT (2-year) @ 110.00
- Long 25 ZN (10-year) @ 139.00
- Spread DV01: 25 units × $147.50 = $3,688
- Margin: ~$43,000
...
| Date | 2yr Yield | 10yr Yield | Spread | Cumulative P&L |
|------|-----------|------------|--------|----------------|
| Jun 2020 | 0.15% | 0.65% | 50 bps | $0 |
| Sep 2020 | 0.13% | 0.68% | 55 bps | +$18,438 |
| Dec 2020 | 0.12% | 0.95% | 83 bps | +$121,688 |
| Mar 2021 | 0.16% | 1.60% | 144 bps | +$346,438 |
| Jun 2021 | 0.25% | 1.50% | 125 bps | +$276,688 |
| Sep 2021 | 0.28% | 1.35% | 107 bps | +$210,188 |
| Dec 2021 | 0.73% | 1.50% | 77 bps | +$99,688 |

**Exit (March 2021 - peak):**

- Spread: 50 bps → 144 bps (widened 94 bps!)
- DV01: 25 units × $147.50 = $3,688
- **P&L: 94 bps × $3,688 = $346,672**
- **Return: 807% on $43,000 margin in 9 months**

**Why this was exceptional:**

**1. Perfect setup:**

- Extreme flatness (COVID panic)
- Clear catalyst (vaccine + recovery)
- Fed anchored short end (ZIRP committed)
- Long end free to rise (growth expectations)

**2. Massive move:**

- 94 bp steepening (huge for Treasuries)
- 10-year: 0.65% → 1.60% (+95 bps)
- 2-year: 0.15% → 0.16% (+1 bp, anchored by Fed)
- **Perfect non-parallel shift**

**3. DV01-neutral protection:**

- Both rates rose overall
- But steepening was the key
- DV01-neutral meant:
  - Short 2s: Lost money (prices up due to lower yields overall)
  - Long 10s: Made more money (benefited from rise in yields being offset by duration)

Actually, wait. Let me reconsider. If 2-year yields went from 0.15% to 0.16% (up 1 bp), prices fell slightly. If we're short, we profit. If 10-year yields went from 0.65% to 1.60% (up 95 bps), prices fell significantly. If we're long, we lose.

But the curve steepened, so the spread DV01 captures this. The key is:

The 2-year yield stayed low (Fed anchored)
The 10-year yield rose significantly
The SPREAD widened

For a DV01-neutral steepener:
- We profit when the spread widens
- The absolute direction matters less

Let me stick with the spread P&L calculation which is correct.

**4. Duration:**

- Held for 9 months (patience)
- Multiple rolls executed
- Compounded through several rate moves

**5. Positive carry:**

- Front contracts in slight backwardation
- Small positive carry offset margin
- **No bleed waiting**

**6. Clean exit:**

- Exited at peak steepening (144 bps)
- Later gave back some (ended at 77 bps in Dec)
- **Took profit at right time**

**Account impact:**

- Starting: $100,000 (allocated $43k to trade)
- Ending: $100,000 + $346,672 = $446,672
- **Gain: 347% on entire account**

**This is curve trading at its absolute best:**

- Extreme setup
- Clear catalyst
- Massive normalization
- Patient execution
- Perfect timing
...
1. **False extreme:** Curve looks extreme but keeps going
2. **Regime shift:** Fundamentals change mid-trade
3. **Central bank intervention:** Fed distorts curve
4. **Correlation breakdown:** Legs move independently
5. **Forced exit:** Margin call or liquidity crisis
6. **Negative carry bleed:** Pay daily to hold position

### Worst Case Example: Fighting the Fed (2022)

**Background:**

- Fed hiking aggressively to fight inflation
- Curve inverting (2s > 10s)
- Market expecting Fed to break economy
...
- 2-year yield: 2.95%
- 10-year yield: 2.98%
- **Spread: 3 bps (nearly flat)**

**Observation:**

- Historically, 2s10s inverts before recessions
- Current: Nearly flat, should invert more OR steepen
- **Most traders bet on steepening (recession → Fed cuts)**

**Trade (the trap):**

- Short 20 ZT @ 104.00
- Long 10 ZN @ 119.00
- **Bet: Curve will steepen (typical recession playbook)**

**What actually happened:**

**Fed kept hiking LONGER and HIGHER than expected!**

| Month | 2yr Yield | 10yr Yield | Spread | P&L |
|-------|-----------|-----------|--------|-----|
| Jun 22 | 2.95% | 2.98% | +3 bps | $0 |
| Jul 22 | 3.15% | 2.85% | -30 bps | -$48,675 |
| Aug 22 | 3.40% | 3.05% | -35 bps | -$56,050 |
| Sep 22 | 4.20% | 3.80% | -40 bps | -$63,425 |
| Oct 22 | 4.50% | 4.05% | -45 bps | -$70,800 |

**Curve inverted to -45 bps (opposite of trade!)**

**Margin call (October):**

- Initial margin: $34,000
- Mark-to-market loss: -$70,800
- Account equity: Wiped out
- **Forced liquidation**

**Final result:**

- Entry: Spread +3 bps
- Forced exit: Spread -45 bps
- **Loss: 48 bps × $1,475 spread DV01 × 10 units = -$70,800**
- **Loss: 208% of initial $34k margin (borrowed from account)**

**What went wrong:**

**1. Fought the Fed:**

- Fed explicitly said "higher for longer"
- Market kept betting on pivot
- **Trade was consensus, wrong**

**2. Curve kept inverting:**

- 2s rose MORE than 10s (fear of Fed breaking economy)
- Inversion deepened to -100 bps (historical extreme)
- **Wrong direction for 4+ months**

**3. No stop loss:**

- "It has to normalize eventually..."
- Kept averaging in (worse!)
...
- **Regime: From transitory inflation to persistent inflation**

**5. Negative carry:**

- Short 2-year: Rates rising fast, prices falling, losing
- Long 10-year: Rates rising slower, prices falling less, but still losing
- **Bleed every day**

**6. Forced exit at worst time:**

- Margin call in October 2022
- Exit at -45 bps
- **Later (2023), curve did steepen to +50 bps**
- Right idea, wrong timing, no capital to survive

**The psychological trap:**

- June: "Curve too flat, must steepen"
- July: "Just temporary, Fed will pivot soon"
- August: "This is extreme, doubling down" ❌
- September: "I'll be vindicated, holding" ❌
- October: "Margin call... liquidated" ❌

**What should have done:**

- Exit in July at -$48,675 (-30% loss, survivable)
- Acknowledge Fed's commitment to higher rates
- Wait for actual pivot signals
- **Cut losses early, live to trade another day**

**The aftermath:**

- 2023: Curve did steepen (back to +50 bps by mid-2023)
- Original thesis eventually correct
- But account blown up before vindication
...
- Don't average into losses (admit wrong)
- Regime shifts invalidate historical patterns
- Survival > being right eventually
...
**Curve trading and butterflies profit from changes in term structure shape rather than directional price moves:**

**Curve steepener:**

$$
\text{Profit} = (\text{Far} - \text{Near})_{\text{final}} - (\text{Far} - \text{Near})_{\text{initial}}
$$

**Butterfly:**

$$
\text{Fly} = \text{Middle} - \frac{\text{Near} + \text{Far}}{2}
$$

- Market-neutral to parallel shifts
- Profit from curve normalization
- Lower volatility than outrights
- Capital-efficient (low margin)

### The Setup

**Standard 2s10s steepener (Treasuries):**

- Short 2 ZT (2-year)
- Long 1 ZN (10-year)
- DV01-neutral ratio
- Margin: ~$1,700 per unit

**Standard butterfly (commodities):**

- 1x-2x-1x ratio
- Near-Middle-Far expirations
- Long or short based on fair value
...
$$
\text{Ratio} = \frac{\text{DV01}_{\text{long}}}{\text{DV01}_{\text{short}}}
$$
...
**Butterfly fair value:**

$$
\text{Fair Value} = \frac{F_{\text{wing1}} + F_{\text{wing2}}}{2}
$$
...
- Position size: Max 2% of account risk
- Stop loss: 10-15 bp adverse move (rates), 30% (commodities)
- DV01-neutral for rates (required)
- Monitor carry (positive or negative?)
- Time stop: 90 days no progress
- Never fight the Fed
...
- Extreme curve shape (inversion or super-steep)
- Clear catalyst (Fed policy, recession, recovery)
- Massive normalization (50-100 bp)
- **Returns: 200-800% on margin over 6-12 months**

**Worst case:**

- Fight central bank policy
- Regime shift mid-trade
- Curve goes further extreme
- No stop loss discipline
- **Max loss: 100-200% of margin (account impairment)**
...
- Avg win: +40-80%
- Avg loss: -25-40%
- **Sharpe ratio: 0.8-1.2 (excellent)**

### When to Use

**Use curve trades when:**

- Curve at historical extremes (above 80th or below 20th percentile)
- Clear fundamental catalyst (Fed policy, recession, recovery)
- DV01-neutral achievable (rate futures)
- Long time horizon (3-12 months patience)
- Low market volatility (smooth normalization)

**Don't use when:**

- Fighting central banks (Fed explicitly committed)
- Curve at historical average (no edge)
- QE distorting specific maturities
- High volatility (whipsaws)
- Short time horizon (need patience)

### Common Mistakes

1. Fighting the Fed or central banks
2. No stop loss ("it has to normalize...")
3. Not DV01-neutral for rates (directional risk)
4. Ignoring carry (negative carry bleeds)
5. Holding into delivery (near contract expiration)
6. Over-sizing (curve trades volatile than thought)
7. Trading consensus (everyone in steepener = crowded)
8. No profit targets (greed kills)
...
- Lower volatility (50-70% less than outrights)
- Higher Sharpe ratios (better risk-adjusted)
- Capital-efficient (lower margin)
- Mean-reverting (curves normalize)

**Disadvantages:**

- Requires understanding of term structure
- DV01 calculations (complexity)
- Lower absolute returns (hedged)
- Patience required (slow normalization)
- Timing critical (early exit hurts)
