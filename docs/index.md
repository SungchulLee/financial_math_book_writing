...
If your project uses additional MkDocs plugins, install them as well:
...
Then open your browser at `http://127.0.0.1:8000`. The page will automatically reload when you modify Markdown files.
...
(`FMNM`) covering PDE methods, Fourier inversion, Levy processes, Kalman filtering,
...
| `VG_pricer` (Variance Gamma PIDE, MC) | Ch 7 -- Extensions and Exotics |
| `NIG_pricer` (Normal Inverse Gaussian) | Ch 7 -- Extensions and Exotics |
...
| `portfolio_optimization` (mean-variance, Sharpe) | Ch 3 -- SDE (Portfolio and Strategy) |
