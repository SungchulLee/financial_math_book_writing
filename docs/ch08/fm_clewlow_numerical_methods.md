...
f
g
Em1 ð1  1=m1Þð1  1=m1Þm11
n
o
¼
1
Em11 ð1  1 þ 1=m1Þð1  1=m1Þm11
A1 ¼ 1
m1
1  1=m1
E
...
A1 ¼ A2B m2m1
Therefore
cdoðS; EÞ ¼ A2B m2m1Sm1 þ A2Sm2
From (ii), as S ! 1:
cdoðS; EÞ ¼ A2B m2m1Sm1 þ A2Sm2 ¼ S
However, since m2 < 0, we have A2Sm2 ! 0, as S ! 1, giving
cdoðS; EÞ ¼ A2B m2m1Sm1 ¼ S
So
A2 ¼  S1m1
Bm2m1
and
cdoðS; EÞ ¼ S1m1Sm1Bm2m1
Bm2m1
 S1m1Sm2
Bm2m1
which results in:
...
n
o
þ D1 expðrðt1  tÞÞN1ðb2Þ
 E expðrÞ N1ðb2Þ expðrð1ÞÞ þ N2ða2; b2; 
ffiffiffiffiffiffiffiffiffiffiffiffiffiffiffiffiffiffiffiffi
ðt1  tÞ=
p
Þ
...
d1 ¼ (log(S_star/X) þ (rþ(sigma*sigma/2.0))*(Tt1))/(sigma*sqrt(Tt1));
putx ¼ 0;
loc_q ¼ 0.0;
black_scholes(&eur_val,NULL,S_star,X,sigma, Tt1,r,loc_q, putx,&iflag);
S_star ¼ (S_star*s15abc(d1)eur_valþdivX)/(s15abc (d1)1.0);
...
temp2 ¼ X*exp(r*T)*g01hac(a2,b2,nt1,&nagerr)(Xdiv)* exp(r*t1)*s15abc(b2);
...
tn ¼ Divs_T[n_divs1];
temp ¼ temp þ dividends[n_divs1]*exp(r*tn);
...
S_star ¼ X;
while (iterate){/* calculate S_star, iteratively */
d1 ¼ log(S_star/X) þ (rqþ(sigma*sigma/2.0))*T;
d1 ¼ d1/(sigma*sqrt(T));
...
rhs ¼ eur_valþ(1.0exp (q*T)*s15abc(d1)) *S_star/gamma_2;
...
putx ¼ 1;
black_scholes(&eur_val,NULL,S_star,X,sigma, T,r,q,putx,&iflagx);
rhs ¼ eur_val(1.0exp(q*T)þexp(q*T)*s15abc(d1)) *S_star/gamma_1;
...
ð10:71Þ
Lognormal variance
Var½X ¼ E½ðX  E½XÞ2 ¼ E½X2  ðE½XÞ2 ¼ expð2 þ 
2Þ expð
2Þ  1
...
distribution Stþt, given that we know the asset price, St, at time instant t. To do this
...
over the next time step t. Here we will assume that the new asset price, Stþt, is Stu
...
E½Stþt ¼ pStu þ ð1  pÞStd ¼ St expðrtÞ
ð10:80Þ
The corresponding equation for the variance requires a little more work:
Var½Stþt ¼ E½ðStþtÞ2  ðE½StþtÞ2
ð10:81Þ
Since
E½ðStþtÞ2 ¼ pðStuÞ2 þ ð1  pÞðStdÞ2 ¼ S2
t pu2 þ ð1  pÞd2


ð10:82Þ
and, from Equation 10.80, we have
ðE½StþtÞ2 ¼ St expðrtÞ
f
g2 ¼ S2
t expð2rtÞ
ð10:83Þ
...
expð2rt þ 2tÞ ¼ a2 expð2tÞ ¼ a2 þ b2
and so
...
ð2 þ 2rt þ 2tÞ2  4ð1 þ 2rtÞ
q

ffiffiffiffiffiffiffiffiffiffiffiffiffiffiffiffiffiffiffiffiffiffiffiffiffiffiffiffiffiffiffiffiffiffiffiffiffiffiffiffiffiffiffiffiffiffiffiffiffiffiffiffiffiffiffi
4 þ 8rt þ 42  4  8rt
p
¼
ffiffiffiffiffiffiffiffiffiffiffiffiffi
42t
...
In general, at time t þ it, there are i þ 1, stock prices; these are:
Si; j ¼ Sujdij;
j ¼ 0; 1; . . . ; i
...
for put options
fn; j ¼ maxðE  Su jdnj; 0Þ;
j ¼ 0; . . . ; n
and for call options
fn; j ¼ maxðSu jdnj  E; 0Þ;
j ¼ 0; . . . ; n
...
The probability of moving from node (i, j) at time it to node (i þ 1, j þ 1) at time
(i þ 1)t is p, and the probability of moving from node (i, j) at time it to the node
(i þ 1, j) at time (i þ 1)t is 1  p. If we assume that there is no early exercise then:
f E
i; j ¼ expðrtÞ pfiþ1; jþ1 þ ð1  pÞfiþ1; j
...
ind ¼ Mm1þ1;
for (n ¼0; n < m1; þþn){
hold ¼ p_d*v[5jj m11] þ p_u*v[5jjm1];
if (is_american) {
if (put)
...
V ¼ fþ  f

where fþ is the option value computed using a binomial lattice with volatility
...
ind ¼ Mm1þ1;
for (n ¼0; n < m1; þþn) {
hold ¼ p_d*a_v[5jjm11] þ p_u*a_v[5jjm1];
if (put)
a_v[5jj] ¼ MAX(hold, Xs[ind]);
else
a_v[5jj] ¼ MAX(hold, s[ind]X);
e_v[5jj] ¼ p_d*e_v[5jjm11] þ p_u*e_v[5jjm1];
jj;
ind ¼ ind þ 2;
}
}
...
if(greeks) {
/* assign the value of delta (obtained from m1 ¼ 1) */
a_delta ¼ (a_v[4]a_v[3])/(s[Mþ1]s[M1]);
e_delta ¼ (e_v[4]e_v[3])/(s[Mþ1]s[M1]);
...
for (m1 ¼ 1; m1 <¼ M1; þþm1){/* Calculate asset values up to (M1)th time step */
for (n ¼ m1; n >¼ 1; n){
þþjj;
s[jj] ¼ u*s[jjm1];
}
...
for (n ¼ 0; n <¼ M1; þþn){/* Use Black—Scholes for the final step */
...
5:0869  103, while that for an 80 time step BBSR lattice is 3:5725  103; in Table
10.6 the error for an 80 time step BBS lattice is 6:3858  103 and that for a 40 time
step BBSR lattice is 3:5725  103.
10.5
...
make use of Ito’s lemma, and write Stþt for the asset price at time t þ t, Equation
...
expected value of si one time step later. That is Fi ¼ si exp (rt), or in terms of the up
...
10.111 gives:
expðrtÞCðsi; tnþ1Þ ¼ ipi ðSiþ1  siÞ þ 
ð10:113Þ
where  ¼ Pn
...
si1, while those in lattice level n þ 1 are represented by Siþ2, Siþ1, and Si. The transition probabilities
between lattice level n and lattice level n þ 1 are piþ1, pi, and pi1, and the forward prices are Fiþ1, Fi, and
Fi1. If the computed stock value is Siþ1 then, in order to obtain valid transition probabilities, it must
...
Siþ1 ¼ Fi þ 
ð10:122Þ
where  is a very small number (say 106). It can be seen from Equation 10.114 that
...
The transition probability of an up jump from Si1, j to Si, jþ1 is denoted by pj, and
that of the corresponding down jump transition probability 1  pj by q. The forward
for Si1, j is denoted by Fj and, since Si1, j ¼ K, we have:
Fj ¼ Si1; j expðrtÞ ¼ K expðrtÞ
ð10:132Þ
...
values,
Sj ¼ jS,
j ¼ 0, . . . , ns1, where S is the spacing between grid points. If Smax is the maximum
...
This leads to the new asset price discretization Sj ¼ jS j ¼ 0, . . . , ns1, where we
...
instants, ti ¼ it, i ¼ 0, . . . , nt, and the time step is simply:
t ¼ 
nt
ð10:140Þ
...
The finite-difference approximation
The option value corresponding to the grid node at which ti ¼ it and Sj ¼ jS
...
fi; jþ1 þ fi; j1 ¼ 2fi; j þ f 00
i; jS2
which gives:
f 00
i; j ¼ fi; jþ1  2fi; j þ fi; j1
S2
ð10:148Þ
...
¼ fiþ1; j  fi; j þ ðr  qÞjtA1
2
þ 2j2tA2
2
ð10:149Þ
where we have used the fact that Sj ¼ jS, and for compactness have defined the
terms:
A1 ¼ m fiþ1; j þ1  m fiþ1; j1 þ 	
m fi; jþ1  	
m fi; j1
and
A2 ¼ m fiþ1; jþ1 þ m fiþ1; j1  2m fiþ1; j þ 	
m fi; jþ1 þ 	
m fi; j1  2	
m fi; j
...
fiþ1, j1) at time index i þ 1. This can be achieved by rearranging Equation 10.150
as follows:
Finite-difference scheme for a uniform grid
aj fi; j1 þ bj fi; j þ cj fi; jþ1 ¼ Riþ1; j
ð10:151Þ
where the right hand side, Riþ1, j, is:
Riþ1; j ¼ aj fiþ1; j1 þ bj fiþ1; j þ cj fiþ1; jþ1
ð10:152Þ
...
values, fiþ1, j1, fiþ1, j, fiþ1, jþ1 at time index i þ 1, and three option values fi, j1, fi, j,
...
fi; j ¼ aj fiþ1; j1 þ bj fiþ1; j þ cj fiþ1; jþ1
...
fiþ1, j1, fiþ1, j, fiþ1, jþ1. This is the simplest situation to deal with and actu-
...
neighbouring unknown option values fi, j1 and fi, jþ1. It is now necessary to solve a set
...
unknown value fi, j only depends on the neighbouring values fi, j1, fi, jþ1 and its
...
The boundary conditions
In order to solve Equation 10.151 at time instant it we need to obtain the option
...
and for put options
pns1 ¼ 0
The option value at the upper boundary, denoted by fBU, is set to pns1, and we have
fi, ns1 ¼ fBU, i ¼ 0, . . . , nt.
Lower asset boundary values.
At the lower boundary j ¼ 0, and the value of jS
...
10.151 at time instant ti ¼ it.
First we note that since fi,0 ¼ fBL and fi,ns1 ¼ fBU, Equation 10.151 only needs to
be solved for values of the asset index j in the range j ¼ 1 to j ¼ ns2. We now deal
...
b1 fi;1 þ c1 fi;2 ¼ ða1  a1ÞfBL þ b1 fiþ1;1 þ c1 fiþ1;2
or equivalently:
b1 fi;1 þ c1 fi;2 ¼ Riþ1;1
ð10:159Þ
where
Riþ1;1 ¼ ða1  a1Þ fBL þ b1 fiþ1;1 þ c1 fiþ1;2
ð10:160Þ
184
Pricing Assets

CASE 2: j ¼ ns2
Substituting j ¼ ns1 into Equation 10.151 we obtain:
ans2 fi;ns3 þ bns2 fi;ns2 þ cns2 fi;ns1 ¼ ans2 fiþ1;ns3 þ bns2 fiþ1;ns2 þ cns2 fiþ1;ns1
Since fi, ns1 ¼ fBU this gives:
ans2 fi;ns3 þ bns2 fi;ns2 ¼ ans2 fiþ1;ns3 þ bns2 fiþ1;ns2 þ ðcns2  cns2Þ fBU
or equivalently:
ans2 fi;ns3 þ bns2 fi;ns2 ¼ Riþ1;ns2
ð10:161Þ
where
Riþ1;ns2 ¼ ans2 fiþ1;ns3 þ bns2 fiþ1;ns2 þ ðcns2  cns2Þ fBU
ð10:162Þ
CASE 3
...
Ax ¼ R
ð10:166Þ
where A is the ns2  ns2 tridiagonal matrix containing the known coefficients
aj, j ¼ 2, . . . , ns2, bj, j ¼ 1, . . . , ns2, and cj, j ¼ 1, . . . , ns3. The vector R denotes
the known right hand side, Riþ1, j, j ¼ 1, . . . , ns2, and the vector x contains the
unknown option values that we wish to compute, fi, j, j ¼ 1, . . . , ns2.
...
Ax ¼ ðLUÞx ¼ LðUxÞ ¼ Ly ¼ R
We will now provide code excerpts which show how to solve the ns2  ns2 tridia-
...
l[j]¼ a[j]/u[j1]. Also we do not need to compute the upper diagonal
...
mentioned the sub-diagonal elements of L are given by l[j] = a[j]/u[j1]. This
means that in Code excerpt 10.15, the line:
is in fact be equivalent to:
where l[j], j ¼ 2,.., ns2 contains the sub-diagonal elements of L, if we had
...
values, fi, j, j ¼ 1, . . . , ns2, in Equation 10.6.2 and represent the solution of the
work[1] ¼ rhs[1];
for(j¼ 2; j<¼ns 2; þþj) {
...
Black–Scholes partial differential equation at time instant ti ¼ it; based on the
previously computed option values fiþ1, j, j ¼ 1, . . . , ns2.
Backwards iteration and early exercise
...
when time index i ¼ 0 is reached. It can be seen that the grid method yields ns2
option values, f0, j, j ¼ 1, . . . , ns2, which correspond to the current asset prices
Sj
0 ¼ jS;
j ¼ 1; . . . ; ns2
...
ns ¼ n1þn2 þ 1;
/* Note: Now nps ¼ ns1. Since we define asset grid lines 0 . . . ns1, this is the maximum grid line;
...
c[i] ¼ i*(i*sig2þ(rq))*t2*tmp;
c1[i] ¼ i*(i*sig2þ(rq))*t2*theta_m;;
...
j we then obtain
rtðm fiþ1; j þ 	
m fi; jÞ ¼ fiþ1; j  fi; j þ ðr  qÞSjtA1
D
þ
2S2
j tA2
...
aj fi; j1 þ bj fi; j þ cj ¼ Riþ1; j
ð10:176Þ
where the right hand side Riþ1, j is:
Riþ1; j ¼ aj fiþ1; j1 þ bj fiþ1; j þ cj fiþ1; jþ1
ð10:177Þ
...
vides the relationship between the three option values fiþ1, j1, fiþ1, j, fiþ1, jþ1 at time
index i þ 1, and the three option values fi, j1, fi, j, fi, jþ1 at time index i. It can also
...
create another one*/
for (i¼1; i < ns1barrier_index; þþi){
...
temp2 ¼ ds_minus/D;
c[i] ¼ time_step*tmp*(temp1*s[i]*(rq)þ(sig2*s[i]* s[i]*temp2));
c1[i] ¼ time_step*theta_m*(temp1*s[i]*(rq)þ(sig2*s[i] *s[i]*temp2));
temp1 ¼ ((ds_minus*ds_minus)  (ds_plus*ds_plus))/D;
temp2 ¼ (ds_minusþds_plus)/D;
b[i] ¼ 1.0þtime_step *tmp*(rþ((rq)*s[i]*temp1)þ (s[i]* s[i]*sig2)*temp2);
b1[i] ¼ 1.0time_step *theta_m*(rþ((rq)*s[i]*temp1)þ (s[i]*s[i]*sig2)*temp2);
}
...
/* Set option values at maturity. Note : opt_vals[0] amd opt_vals[ns11] are the lower and upper (put/call)
...
for( j¼nt1; j>¼2; j){/* go two steps past current time so that can evaluate theta */
...
rhs[ns12] ¼ a1[ns12]*opt_vals[ns13]þ b1[ns12]*opt_vals[ns12]þ
(c1[ns12]c[ns12])*opt_vals[ns11];
/* Solve the lower triangular system Ly ¼ b, where y is stored in array work[].
Compute the elements of L from those of U, l[i] ¼ a[i]/u[i1]. */
work[1] ¼ rhs[1];
for( i¼2; i<¼ns12; þþi ){
...
temp3 ¼ temp1temp2;
/* GAMMA */
greeks[0] ¼ (ds_minus*vals[n1þ1] þ ds_plus*vals[n11]  vals [n1]*(ds_plusþds_minus))/(0.5*D);
/* DELTA */
greeks[1] ¼ (temp1*vals[n1þ1]  temp2*vals[n11]  vals [n1]*temp3)/D;
/* THETA */
...
aj fi; j1 þ bj fi; j þ cj ¼ aj fiþ1; j1 þ bj fiþ1; j þ cj fiþ1; jþ1
ð10:188Þ
where:
aj ¼ ð1  mÞt
2Z2
...
bb ¼ r  q  (sig2/2.0);
--ind2;
for( i ¼ 1; i<¼ns1  2; þþi){/* Assign elements of the (ns12)*(ns12) tridiagonal matrix */
ds_plus ¼ z[iþ1]z[i];
ds_minus ¼ z[i]  z[i1];
...
/* Set up the rhs of equation for the theta method */
for(i¼2; i<¼ns13; þþi)
rhs[i] ¼ a1[i]*opt_vals[i1]þb1[i]*opt_vals[i]þ c1[i]*opt_vals[iþ1];
/* Incorporate the boundary conditions1 at the upper/lower asset value boundaries */
rhs[1] ¼ (a1[1]a[1])*opt_vals[0]þ b1[1]*opt_vals[1]þ c1[1]*opt_vals[2];
rhs[ns12] ¼ a1[ns12]*opt_vals[ns13]þb1[ns12] *opt_vals[ns12]þ
(c1[ns12]c[ns12])*opt_vals[ns11];
/* Solve the lower triangular system Ly ¼ b, where y is stored in array work[]. Compute the elements of L from
those of U, l[i] ¼ a[i]/u[i1]. */
work[1] ¼ rhs[1];
for(i ¼ 2; i<¼ns12; þþi){
work[i] ¼ rhs[i]  a[i]*work[i1]/u[i1];
}
...
greeks[1] ¼ (vals[n1þ2]þ8.0*vals[n1þ1] 8.0*vals[n11]þ vals[n12])/(12.0*dz1);
/* Compute gamma (4th order accuracy)  use chain rule to obtain derivative wrt S */
greeks[0] ¼ (vals[n1þ2]þ16.0*vals[n1þ1] 30.0*vals[n1]þ16.0*vals[n11]vals[n12])/
(12.0*dz1*dz1);
...
time step by f k
i .
The option values at the terminal nodes, time instant td1, are computed in the
