"""
Black Scholes Cn Amer Call

Educational script demonstrating black scholes cn amer call concepts.
"""

# ============================================================================
# black_scholes_RUN_CN_SCHEME_FOR_AMERICAN_CALL.py
# ============================================================================
...
if __name__ == "__main__":
    ...
    ax.set_title(f'American {option_type.capitalize()} Option: CN FDM Comparison\n' +
    ...
    print("SUMMARY")
    print("="*70)
    print(f"✅ Both numerical methods successfully price the American {option_type}")
