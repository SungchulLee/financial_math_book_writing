...
Its sole purpose is to ensure arbitrage-free pricing. At a deeper level, the change
from \(\mathbb{P}\) to \(\mathbb{Q}\) is equivalent to introducing a **stochastic
discount factor** (SDF) that reweights outcomes: market prices embed both physical
probabilities and risk preferences, and the measure change absorbs this combined
