...
* [Martingales and No-Arbitrage](martingale_and_no_arbitrage.md) — the economic requirement demanding control
* [Risk-Neutral Valuation](risk_neutral_valuation_principle.md) — the payoff of achieving control
