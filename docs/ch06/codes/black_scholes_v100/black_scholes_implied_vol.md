...
u = \partial C/\partial \sigma$ is vega.
    ...
    Starting from $\sigma_0 = 0.20$: compute $C_{\mathrm{BS}}(0.20) pprox 10.45$ and $
u(0.20) pprox 39.4$. Then $\sigma_1 = 0.20 - (10.45 - 12.50)/39.4 = 0.20 + 0.052 = 0.252$. Continue iterating until $|C_{\mathrm{BS}}(\sigma_n) - 12.50| < psilon$.
