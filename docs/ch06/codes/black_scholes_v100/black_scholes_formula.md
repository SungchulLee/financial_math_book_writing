...
??? success "Solution to Exercise 1"
    Under the risk-neutral measure, $S_T = S_0 xp\!igl((r - q - \frac{1}{2}\sigma^2)T + \sigma\sqrt{T}\,Zigr)$ where $Z \sim \mathcal{N}(0,1)$.
...
??? success "Solution to Exercise 2"
    ...
    From tables: $\Phi(-0.1027) pprox 0.4591$, $\Phi(-0.2795) pprox 0.3899$.

    $$
    C = 100 \times 0.4591 - 105 \times e^{-0.015} \times 0.3899 pprox 45.91 - 40.32 = \$5.59
    $$
